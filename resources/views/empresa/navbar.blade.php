<nav class="main-header navbar navbar-expand navbar-white navbar-light">
   ...
   <ul class="navbar-nav">
     ...
     <li class="nav-item d-none d-sm-inline-block {{(request()->segment(3)=='go') ? 'active' : ''}}"> 
       <a href="#" class="nav-link">Go</a>
     </li>
     <li class="nav-item d-none d-sm-inline-block {{(request()->segment(3)=='bancos') ? 'active' : ''}}">
