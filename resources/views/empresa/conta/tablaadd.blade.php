   ...
   <tbody>
       ...
       @csrf
           <tr>
               ...
               <td class="px-0"><input tabindex="6" class="focusNext form-control form-control-sm text-right unstyled" type="number" step="0.01" name="base10" onblur="baseporiva('#base10','#iva10','0.10');" id="base10" value="{{ old('base10', '') }}"></td>
               ...
               <td class="px-0"><input tabindex="7" class="focusNext form-control form-control-sm text-right unstyled" type="number" step="0.01" name="base4" id="base4" onblur="baseporiva('#base4','#iva4','0.04');" value="{{ old('base4', '') }}"></td>
               ...
               <td class="px-0"><input tabindex="8" class="focusNext form-control form-control-sm text-right unstyled" type="number" step="0.01" name="exento" id="exento" onblur="total();"value="{{ old('exento', '') }}"></td>
